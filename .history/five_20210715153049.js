...
function ternarCheck(userData){
    return userData.isAdmin && userData.age >= 18 && userData.age<=35 ? true :
    userData.age >= 18 && userData.age<=35 && userData.paid && !userData.blocked && !userData.badUsername 
}
console.log(ternarCheck(data))
